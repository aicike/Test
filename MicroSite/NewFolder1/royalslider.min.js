...
(function (n) {
    ...
    n.rsModules || (n.rsModules = {
        ...
        "_t": function () {
            ...
            this._z && 0 < b && (4 >= this.numSlides ? b = 1 : this.st.numImagesToPreload > (this.numSlides - 1) / 2 && (b = Math.floor((this.numSlides - 1) / 2))), this._y = b;
        },
        "_s": function (b, f) {
            function c(b, c) {
            ...
            b = n(b), a._k2 = b, a.ev.trigger("rsBeforeParseNode", [b, g]);
        ...
        "destroy": function (b) {
            this.ev.trigger("rsBeforeDestroy"), this._b.off("keydown" + this.ns + " keyup" + this.ns + " " + this._k1 + " " + this._l1), this._p1.off(this._j1 + " click"), this.slider.data("royalSlider", null), n.removeData(this.slider, "royalSlider"), n(window).off("resize" + this.ns), b && this.slider.remove(), this.ev = this.slider = this.slides = null;
        },
        "_n2": function (b, f) {
            function c(c, f, g) {
        ...
        "setItemHtml": function (b, f) {
            var c = this, a = function () {
                if (!b.images) b.isRendered = !0, b.isLoaded = !0, b.isLoading = !1, d(!0); else if (!b.isLoading) {
                    var a, f;
                    b.content.hasClass("rsImg") ? (a = b.content, f = !0) : a = b.content.find(".rsImg:not(img)"), a && !a.is("img") && a.each(function () {
                        var a = n(this), c = '<img class="rsImg" src="' + (a.is("a") ? a.attr("href") : a.text()) + '" />';
                        f ? b.content = n(c) : a.replaceWith(c);
                    }), a = f ? b.content : b.content.find("img.rsImg"), k(), a.eq(0).addClass("rsMainSlideImage"), b.iW && b.iH && (b.isLoaded || c._q2(b), d()), b.isLoading = !0;
        ...
        "_g2": function (b, f) {
            ...
            c._s2 = e, c.ev.trigger("rsDragStart");
            if (n(b.target).closest(".rsNoDrag", c._r1).length) return c.dragSuccess = !1, !0;
            !f && c._r2 && (c._t2 = !0, c._u2()), c.dragSuccess = !1;
        ...
        "_k3": function (b, f) {
            if (this._l3) {
                ...
                this._a3 = !0, this._b3 = b.pageX, this._c3 = b.pageY, "x" === d && 0 !== a ? this._f3 = 0 < a ? 1 : -1 : "y" === d && 0 !== e && (this._g3 = 0 < e ? 1 : -1), d = h ? this._b3 : this._c3, a = h ? a : e, f ? g > this._n3 ? g = this._h3 + a * this._n1 : g < this._o3 && (g = this._h3 + a * this._n1) : this._z || (0 >= this.currSlideId && 0 < d - this._d3 && (g = this._h3 + a * this._n1), this.currSlideId >= this.numSlides - 1 && 0 > d - this._d3 && (g = this._h3 + a * this._n1)), this._h3 = g, 200 < c - this._j3 && (this._j3 = c, this._v = d), f ? this._q3(this._h3) : this._l && this._p3(this._h3);
            }
        },
        "_x2": function (b, f) {
        ...
        "_y2": function (b, f) {
            ...
            if (!e._s2 || g) if (e._s2 = !1, e.ev.trigger("rsDragRelease"), e._u3 = null, e._l2 = !1, e._r3 = !1, e._l3 = !1, e._m3 = 0, cancelAnimationFrame(e._t3), e._a3 && (f ? e._q3(e._h3) : e._l && e._p3(e._h3)), e._b.off(e._k1).off(e._l1), g && e._e1.off(e._m1), e._i1(), !e._a3 && !e._v2 && f && e._w3) {
                ...
                if (!e._a3 || "y" === e._z2 && d || "x" === e._z2 && !d) {
                    if (!!f || !e._t2) {
                        e._t2 = !1, e.dragSuccess = !1;
                        return;
                    }
                    e._t2 = !1;
                    if (e.st.navigateByClick) {
                        e._i2(e.pointerEnabled ? b.originalEvent : b), e.dragSuccess = !0;
                        return;
                    }
                    e.dragSuccess = !0;
                ...
                Math.abs(m - p), g = m - g, d = (new Date).getTime() - e._j3, d = Math.abs(g) / d;
                if (0 === v || 1 >= s) a(!0, d); else {
                    ...
                    if (f) {
                        ...
                        if (h > e._n3) h = e._n3; else if (h < e._o3) h = e._o3; else {
                            m = d * d / .006, l = -e._i3, p = e._y3 - e._z3 + e._i3, 0 < g && m > l ? (l += e._z3 / (15 / (m / d * .003)), d = d * l / m, m = l) : 0 > g && m > p && (p += e._z3 / (15 / (m / d * .003)), d = d * p / m, m = p), l = Math.max(Math.round(d / .003), 50), h += m * (0 > g ? -1 : 1);
                            if (h > e._n3) {
        ...
        "updateSliderSize": function (b) {
            ...
            if (b || f != this.width || c != this.height) {
                this.width = f, this.height = c, this._b4 = f, this._c4 = c, this.ev.trigger("rsBeforeSizeSet"), this.ev.trigger("rsAfterSizePropSet"), this._e1.css({
                    "width": this._b4,
                    "height": this._c4
        ...
        "appendSlide": function (b, f) {
            ...
            this.slides.splice(f, 0, c), this.slidesJQ.splice(f, 0, n('<div style="' + (this._l ? "position:absolute;" : this._n) + '" class="rsSlide"></div>')), f < this.currSlideId && this.currSlideId++, this.ev.trigger("rsOnAppendSlide", [c, f]), this._f4(f), f === this.currSlideId && this.ev.trigger("rsAfterSlideChange");
        },
        ...
        "_f4": function (b) {
            var f = this;
            b = f.numSlides, b = 0 >= f._u ? 0 : Math.floor(f._u / b), f.numSlides = f.slides.length, 0 === f.numSlides ? (f.currSlideId = f._d1 = f._u = 0, f.currSlide = f._g4 = null) : f._u = b * f.numSlides + f.currSlideId;
            for (b = 0; b < f.numSlides; b++) f.slides[b].id = b;
            f.currSlide = f.slides[f.currSlideId], f._r1 = f.slidesJQ[f.currSlideId], f.currSlideId >= f.numSlides ? f.goTo(f.numSlides - 1) : 0 > f.currSlideId && f.goTo(0), f._t(), f._l && f._z && f._p1.css(f._g + f._u1, "0ms"), f._h4 && clearTimeout(f._h4), f._h4 = setTimeout(function () {
        ...
        "_m2": function (b, f, c, a, e) {
            var g = this, d, h, k;
            g.ev.trigger("rsBeforeMove", [b, a]), k = "next" === b ? g.currSlideId + 1 : "prev" === b ? g.currSlideId - 1 : b = parseInt(b, 10);
            if (!g._z) {
                if (0 > k) {
                    g._i4("left", !a);
                    return;
            ...
            p > g.numSlides - 1 ? p = g.numSlides - 1 : 0 > p && (p = 0), k = m ? p - k : k - p, k > g._y && (k = g._y);
        ...
        "_u2": function (b) {
            this._r2 = !1, clearTimeout(this.loadingTimeout);
            if (this._l) {
                if (!this._e) this._p1.stop(!0), this._p = parseInt(this._p1.css(this._x1), 10); else if (!b) {
                    b = this._p;
        ...
        "_q2": function (b, f) {
            if (!b.isRendered) {
                ...
                b.videoURL && (a = "rsVideoContainer", "fill" !== d ? e = !0 : (h = c, h.hasClass(a) || (h = h.find("." + a)), h.css({
                    "width": "100%",
                    "height": "100%"
                }), a = "rsMainSlideImage")), c.hasClass(a) || (c = c.find("." + a));
                if (c) {
                    var k = b.iW, l = b.iH;
                    b.isRendered = !0;
                    if ("none" !== d || g) {
                        ...
                        "none" !== d && (q.width = k, q.height = l, e && c.find(".rsImg").css({
                            "width": "100%",
                            "height": "100%"
                        })), g && (q.marginLeft = Math.floor((h - k) / 2) + a, q.marginTop = Math.floor((n - l) / 2) + a), c.css(q);
                    }
                }
            }
        }
    ...
    l.extend(l.rsProto, {
        ...
        "_u4": function (m) {
            ...
            a._s4 = [], m.each(function (m) {
                ...
                c = {}, a._e && (c[a._g + a._u1] = "0ms"), c.moveProp = g.moveProp, c.opacity = g.opacity, c.display = "none", a._r4.push({
                    "block": b,
                    "css": c
                    ...
                    return function () {
                        ...
                        if (c) {
                            ...
                            if (a._e) {
                                var f = "";
                                c.hasMove && (f += c.moveProp), c.hasFade && (c.hasMove && (f += ", "), f += "opacity"), g[a._g + a._t1] = f, g[a._g + a._u1] = c.speed + "ms", g[a._g + a._v1] = c.css3Easing, b.css(g), setTimeout(function () {
                                    b.css(d);
                                }, 24);
    ...
    b.extend(b.rsProto, {
        "_x4": function () {
            ...
            a._y4 = {
                ...
                "pauseOnHover": !0,
                "delay": 2e3
            }, !a.st.autoPlay && a.st.autoplay && (a.st.autoPlay = a.st.autoplay), a.st.autoPlay = b.extend({}, a._y4, a.st.autoPlay), a.st.autoPlay.enabled && (a.ev.on("rsBeforeParseNode", function (a, c, f) {
                c = b(c);
    ...
    c.extend(c.rsProto, {
        "_i5": function () {
            ...
            "bullets" === a.st.controlNavigation && (a.ev.one("rsAfterPropsSetup", function () {
                ...
                var b = a.currSlideId;
                a._n5 && a._n5.removeClass("rsNavSelected"), b = a._l5.eq(b), b.addClass("rsNavSelected"), a._n5 = b;
            }));
        }
...
-1 !== m && (a.st.startSlideId = m), k && (d(window).on("hashchange" + a.ns, function (b) {
    ...
    g && clearTimeout(g), f && clearTimeout(f), f = setTimeout(function () {
        l = !0, window.location.replace(("" + window.location).split("#")[0] + e + (a.currSlideId + 1)), g = setTimeout(function () {
            l = !1, g = null;
        }, 60);
    }, 400);
})), a.ev.on("rsBeforeDestroy", function () {
    ...
    d.fn[f] = function (b) {
        ...
        function b() {
            var c = g(), n = r(h);
            c !== h ? (p(h = c, n), d(a).trigger(f)) : n !== h && (location.href = location.href.replace(/#.*/, "") + n), e = setTimeout(b, d.fn[f].delay);
        }
        ...
        return c.start = function () {
            ...
            c.start = function () {
                ...
                b !== e && (c.title = k.title, c.open(), g && c.write('<script>document.domain="' + g + '"</script>'), c.close(), a.location.hash = b);
            };
        } (), c;
    } ();
    ...
    e.extend(e.rsProto, {
        "_f6": function () {
            ...
            "tabs" === a.st.controlNavigation && (a.ev.on("rsBeforeParseNode", function (a, d, b) {
                ...
                var c = a.currSlideId;
                a._n5 && a._n5.removeClass("rsNavSelected"), c = a._l5.eq(c), c.addClass("rsNavSelected"), a._n5 = c;
            }));
        },
        "_g6": function () {
            var a = this, c;
    ...
    g.extend(g.rsProto, {
        "_h6": function () {
            ...
            "thumbnails" === a.st.controlNavigation && (a._i6 = {
                ...
                b = g(b), c.thumbnail = b.find(".rsTmb").remove(), c.thumbnail.length ? c.thumbnail = g(document.createElement("div")).append(c.thumbnail).html() : (c.thumbnail = b.attr("data-rsTmb"), c.thumbnail || (c.thumbnail = b.find(".rsImg").attr("data-rsTmb")), c.thumbnail = c.thumbnail ? '<img src="' + c.thumbnail + '"/>' : "");
            }), a.ev.one("rsAfterPropsSetup", function () {
                a._k6();
                ...
                e = "<div" + a._n6 + ' class="rsNavItem rsThumb">' + a._o6 + b.thumbnail + "</div>", c >= a.numSlides ? a._s3.append(e) : a._l5.eq(c).before(e), a._l5 = a._s3.children(), a.updateThumbsSize();
        ...
        "_a4": function (a, e, b, c, f) {
            var d = this;
            if (d._l6) {
                e || (e = d.st.thumbs.transitionSpeed), d._i3 = a, d._x6 && clearTimeout(d._x6), d._p6 && (d._e || d._s3.stop(), b = !0);
                var h = {};
                d._p6 = !0, d._e ? (h[d._g + "transition-duration"] = e + "ms", h[d._g + "transition-timing-function"] = b ? g.rsCSS3Easing[d.st.easeOut] : g.rsCSS3Easing[d.st.easeInOut], d._s3.css(h), d._q3(a)) : (h[d._e3 ? d._x1 : d._w1] = a + "px", d._s3.animate(h, e, b ? "easeOutCubic" : d.st.easeInOut)), c && (d._i3 = c), d._y6(), d._x6 = setTimeout(function () {
                    d._p6 = !1, f && (d._a4(c, f, !0), f = null);
                }, e);
            }
        },
        "_y6": function () {
    ...
    f.extend(f.rsProto, {
        "_z6": function () {
            ...
            a._a7 = {
                ...
                "autoHideCaption": !1,
                "disableCSS3inFF": !0,
                "youTubeCode": '<iframe src="#" frameborder="no"></iframe>',
                "vimeoCode": '<iframe src="#" frameborder="no" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>'
        ...
        "_f7": function (a, d) {
            ...
            c.autoHideArrows && (this._c2 && (b.push(this._c2, this._d2), this._e2 = !a), this._v5 && b.push(this._v5)), c.autoHideControlNav && this._k5 && b.push(this._k5), c.autoHideBlocks && this._d7.animBlocks && b.push(this._d7.animBlocks), c.autoHideCaption && this.globalCaption && b.push(this.globalCaption), this.slider[a ? "removeClass" : "addClass"]("rsVideoPlaying");
    ...
    d.rsProto._g7 = function () {
        ...
        a.st.visibleNearby && a.st.visibleNearby.enabled && (a._h7 = {
            ...
            b = c.breakpoint && a.width < c.breakpoint ? c.breakpointCenterArea : c.centerArea, a._h ? (a._b4 *= b, a._i7.css({
                "height": a._c4,
                "width": a._b4 / b
            }), a._d = a._b4 * (1 - b) / 2 / b) : (a._c4 *= b, a._i7.css({
                "height": a._c4 / b,
                "width": a._b4
            }), a._d = a._c4 * (1 - b) / 2 / b), c.navigateByCenterClick || (a._q = a._h ? a._b4 : a._c4), c.center && a._e1.css("margin-" + (a._h ? "left" : "top"), a._d);
        }));
