...
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (21, 0, N'项目和账号管理', N'项目和账号管理', NULL, N'AccountMain', N'Index', 1, 5,0,2)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (22, 0, N'售楼部信息', N'售楼部信息', NULL, N'BasisSet', N'Index', 2, 5,0,2)
--
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (23, 0, N'用户端资讯', N'用户端资讯', NULL, N'AppAdvertorial', N'Index', 1,6,0,2)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (24, 0, N'销售端资讯', N'销售端资讯', NULL, N'AppAdvertorialAccount', N'Index', 2,6,0,2)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (25, 0, N'调查问卷', N'调查问卷', NULL, N'SurveyMain', N'IndexMain', 3, 6,0,2)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (26, 0, N'活动', N'活动', NULL, N'ActivityInfo', N'Index', 4, 6,0,2)
--
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (27, 0, N'关键词自动回复', N'关键词自动回复', NULL, N'KeywordMessage', N'Index', 1, 7,0,2)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (28, 0, N'App等待画面', N'App等待画面', NULL, N'AppWaitImg', N'Index', 2, 7,0,2)
--
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (29, 0, N'账号信息', N'账号信息', NULL, N'Set', N'Index', 1, 8,0,2)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (30, 0, N'素材管理', N'素材管理', NULL, N'LibraryImage', N'Index', 2, 8,0,2)
-----------3级-------------
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (31, 0, N'用户管理', N'用户管理', NULL, N'UserManage', N'Index', 1, 9,0,3)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (32, 0, N'销售消息', N'销售消息', NULL, N'InstantMes', N'Index', 2, 9,0,3)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (33, 0, N'销售与用户管理', N'销售与用户管理', NULL, N'SalesMessage', N'Index', 3, 9,0,3)
--
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (34, 0, N'新建消息', N'新建消息', NULL, N'Message', N'Index', 1, 10,0,3)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (35, 0, N'已发送', N'已发送', NULL, N'Message', N'History', 2, 10,0,3)
--
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (36, 0, N'会员信息', N'会员信息', NULL, N'VipInfo', N'Index', 1, 11,0,3)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (37, 0, N'卡片管理', N'卡片管理', NULL, N'CardInfo', N'Index', 2, 11,0,3)
--
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (38, 0, N'单元管理', N'单元管理', NULL, N'HouseInfo', N'Index', 1, 20,0,3)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (39, 0, N'户型管理', N'户型管理', NULL, N'HouseType', N'Index', 2, 20,0,3)
--
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (40, 0, N'图片素材', N'图片素材', NULL, N'LibraryImage', N'Index', 1, 30,0,3)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (41, 0, N'语音素材', N'语音素材', NULL, N'LibraryVoice', N'Index', 2, 30,0,3)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (42, 0, N'视频素材', N'视频素材', NULL, N'LibraryVideo', N'Index', 3, 30,0,3)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (43, 0, N'图文素材', N'图文素材', NULL, N'LibraryImageText', N'Index', 4, 30,0,3)
----------4级--------------
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (44, 0, N'房屋管理', N'房屋管理', NULL, N'HouseInfoDetail', N'Index', 1, 38,0,3)
--
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (45, 0, N'聊天窗口', N'聊天窗口', NULL, N'SingleChat', N'Index', 1, 31,0,4)

-----------App菜单----------无需在web端上显示
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level],ServiceID) VALUES (46, 0, N'App权限', N'App权限', NULL, NULL, NULL, 9, NULL,1,1,2)
INSERT [dbo].[Menu] ([ID], [SystemStatus], [Name],[ShowName], [Area], [Controller], [Action], [Order], [ParentMenuID],[IsAppMenu],[Level]) VALUES (47, 0, N'会员管理', N'会员管理', NULL, NULL, NULL, 1, 46,1,1)
...
INSERT INTO dbo.MenuOption (SystemStatus, MenuID,Name,ACTION,[Order] ) VALUES  ( 0,21,'角色管理','Add',5)
INSERT INTO dbo.MenuOption (SystemStatus, MenuID,Name,ACTION,[Order] ) VALUES  ( 0,21,'账号管理','Edit',6)
INSERT INTO dbo.MenuOption (SystemStatus, MenuID,Name,ACTION,[Order] ) VALUES  ( 0,21,'报表管理','Delete',7)
...
INSERT INTO dbo.MenuOption (SystemStatus, MenuID,Name,ACTION,[Order] ) VALUES  ( 0,44,'房屋列表','Index',1)
INSERT INTO dbo.MenuOption (SystemStatus, MenuID,Name,ACTION,[Order] ) VALUES  ( 0,44,'查看房屋详细信息','Select',2)
INSERT INTO dbo.MenuOption (SystemStatus, MenuID,Name,ACTION,[Order] ) VALUES  ( 0,44,'添加房屋','Add',3)
INSERT INTO dbo.MenuOption (SystemStatus, MenuID,Name,ACTION,[Order] ) VALUES  ( 0,44,'修改房屋','Edit',4)
INSERT INTO dbo.MenuOption (SystemStatus, MenuID,Name,ACTION,[Order] ) VALUES  ( 0,44,'删除房屋','Delete',5)
