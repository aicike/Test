namespace EF.Migrations
{
    ...
    public partial class adds : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        IsusePay = c.Boolean(nullable: false),
                        AppUpdateID = c.Int(),
                        SystemUserID = c.Int(),
                ...
                c => new
                    {
                        ...
                        ImagePath = c.String(),
                        TakeOutPrice = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Phone = c.String(nullable: false, maxLength: 50),
                        Content = c.String(),
                        IsPublish = c.Boolean(nullable: false),
                        EnumDataStatus = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        M_TakeOutID = c.Int(),
                        M_MoveID = c.Int(),
                        M_PipelineDredgeID = c.Int(),
                        M_UnlockID = c.Int(),
                        M_DomesticID = c.Int(),
                        M_PetHospitalID = c.Int(),
                        M_EducationTrainID = c.Int(),
                        M_DryCleaningID = c.Int(),
                        M_TutorID = c.Int(),
                        M_ProductID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                .ForeignKey("dbo.M_Domestic", t => t.M_DomesticID)
                .ForeignKey("dbo.M_Move", t => t.M_MoveID)
                .ForeignKey("dbo.M_PipelineDredge", t => t.M_PipelineDredgeID)
                .ForeignKey("dbo.M_Product", t => t.M_ProductID)
                .ForeignKey("dbo.M_Unlock", t => t.M_UnlockID)
                .ForeignKey("dbo.M_DryCleaning", t => t.M_DryCleaningID)
                .ForeignKey("dbo.M_EducationTrain", t => t.M_EducationTrainID)
                .ForeignKey("dbo.M_PetHospital", t => t.M_PetHospitalID)
                .ForeignKey("dbo.M_TakeOut", t => t.M_TakeOutID)
                .ForeignKey("dbo.M_Tutor", t => t.M_TutorID)
                .Index(t => t.AccountMainID)
                .Index(t => t.M_DomesticID)
                .Index(t => t.M_MoveID)
                .Index(t => t.M_PipelineDredgeID)
                .Index(t => t.M_ProductID)
                .Index(t => t.M_UnlockID)
                .Index(t => t.M_DryCleaningID)
                .Index(t => t.M_EducationTrainID)
                .Index(t => t.M_PetHospitalID)
                ...
                c => new
                    {
                        ...
                        MainImage = c.String(nullable: false, maxLength: 50),
                        ShowImage = c.String(),
                        Content = c.String(),
                        Price = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PriceRemark = c.String(nullable: false),
                        IsPublish = c.Boolean(nullable: false),
                        EnumDataStatus = c.Int(nullable: false),
                        CreatDate = c.DateTime(nullable: false),
                        PublishDate = c.DateTime(),
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        SystemStatus = c.Int(nullable: false),
                        M_TakeOutID = c.Int(nullable: false),
                        Title = c.String(nullable: false, maxLength: 50),
                        Price = c.Decimal(nullable: false, precision: 18, scale: 2),
                    })
                .PrimaryKey(t => t.ID)
                ...
                c => new
                    {
                        ...
                        Lottery_dishID = c.Int(),
                        Lottery_eggID = c.Int(),
                        PhoneIsRequired = c.Boolean(nullable: false),
                        NameIsRequired = c.Boolean(nullable: false),
                        EmailIsRequired = c.Boolean(nullable: false),
                        Extension1 = c.String(),
                        Extension1IsRequired = c.Boolean(nullable: false),
                        Extension2 = c.String(),
                        Extension2IsRequired = c.Boolean(nullable: false),
                        Extension3 = c.String(),
                        Extension3IsRequired = c.Boolean(nullable: false),
                        Extension4 = c.String(),
                        Extension4IsRequired = c.Boolean(nullable: false),
                        Extension5 = c.String(),
                        Extension5IsRequired = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Account", t => t.AccountID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                ...
                c => new
                    {
                        ...
                        BrowseCnt = c.Int(nullable: false),
                        UrlID = c.Int(),
                        ActivitySignUrl = c.String(),
                        EnumAdverClass = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                .Index(t => t.AccountMainID);
                ...
                c => new
                    {
                        ...
                        RepairContent = c.String(nullable: false, maxLength: 500),
                        RepairName = c.String(nullable: false, maxLength: 50),
                        RepairPhone = c.String(nullable: false),
                        UserID = c.Int(nullable: false),
                        RepairDate = c.DateTime(nullable: false),
                        Unit = c.String(),
                        RoomNumber = c.String(),
                        EnumRepairStatus = c.Int(nullable: false),
                        EnumRepairScore = c.Int(nullable: false),
                        ImgPath = c.String(),
                        AccountID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        SystemStatus = c.Int(nullable: false),
                        RepairInfoID = c.Int(nullable: false),
                        OperationDate = c.DateTime(nullable: false),
                        OperationContent = c.String(),
                        Remarks = c.String(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.RepairInfo", t => t.RepairInfoID)
                .Index(t => t.RepairInfoID);
                ...
                c => new
                    {
                        ...
                        EnumProductDiscountType = c.Int(nullable: false),
                        Discount = c.Double(),
                ...
                c => new
                    {
                        ...
                        BackgroundColor = c.String(maxLength: 7),
                        ImgPath = c.String(),
                ...
                c => new
                    {
                        ...
                        SystemStatus = c.Int(nullable: false),
                        AccountMainID = c.Int(nullable: false),
                        Property_HouseID = c.Int(nullable: false),
                        UserLoginInfoID = c.Int(),
                        UserName = c.String(nullable: false, maxLength: 10),
                        Phone = c.String(maxLength: 20),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                .ForeignKey("dbo.Property_House", t => t.Property_HouseID)
                .ForeignKey("dbo.UserLoginInfo", t => t.UserLoginInfoID)
                .Index(t => t.AccountMainID)
                .Index(t => t.Property_HouseID)
                .Index(t => t.UserLoginInfoID);
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        SystemStatus = c.Int(nullable: false),
                        AccountMainHouseInfoID = c.Int(),
                        AccountMainID = c.Int(nullable: false),
                        BuildingNum = c.String(nullable: false, maxLength: 50),
                        CellNum = c.String(nullable: false, maxLength: 50),
                ...
                c => new
                    {
                        ...
                        EnumComplaintStatus = c.Int(nullable: false),
                        EnumRepairScore = c.Int(nullable: false),
                        ComplaintContetn = c.String(),
            ...
            CreateTable(
                "dbo.ExpressCollection",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        SystemStatus = c.Int(nullable: false),
                        AccountMainID = c.Int(nullable: false),
                        OddNumber = c.String(nullable: false),
                        Phone = c.String(nullable: false),
                        EntryDate = c.DateTime(nullable: false),
                        EnumExpressStatus = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                .Index(t => t.AccountMainID);
            ...
            CreateTable(
                "dbo.MicroSiteSetInfo",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        SystemStatus = c.Int(nullable: false),
                        AccountMainID = c.Int(nullable: false),
                        IsNeedSendEmail_Order = c.Boolean(nullable: false),
                        IsNeedSendEmail_Pay = c.Boolean(nullable: false),
                        IsNeedSendEmail_CancelOrder = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                .Index(t => t.AccountMainID);
                ...
                c => new
                    {
                        ...
                        OwnerPhone = c.String(nullable: false),
                        Unit = c.String(nullable: false),
                        RoomNumber = c.String(nullable: false),
                        PayDate = c.String(nullable: false),
                        ParkingFees = c.Double(nullable: false),
            ...
            CreateTable(
                "dbo.PropertyOrderDetail",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        SystemStatus = c.Int(nullable: false),
                        AccountMainID = c.Int(nullable: false),
                        PropertyOrderID = c.Int(nullable: false),
                        PropertyFeeInfoID = c.Int(),
                        ParkingFeeID = c.Int(),
                        Title = c.String(),
                        Img = c.String(),
                        Price = c.Double(nullable: false),
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                .ForeignKey("dbo.ParkingFee", t => t.ParkingFeeID)
                .ForeignKey("dbo.PropertyFeeInfo", t => t.PropertyFeeInfoID)
                .ForeignKey("dbo.PropertyOrder", t => t.PropertyOrderID)
                .Index(t => t.AccountMainID)
                .Index(t => t.ParkingFeeID)
                .Index(t => t.PropertyFeeInfoID)
                .Index(t => t.PropertyOrderID);
                ...
                c => new
                    {
                        ...
                        Price = c.Double(nullable: false),
                        status = c.Int(nullable: false),
                        EnumPropertyOrderType = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                .Index(t => t.AccountMainID);
                ...
                c => new
                    {
                        ...
                        SystemStatus = c.Int(nullable: false),
                        AccountMainID = c.Int(nullable: false),
                        PayAccount = c.String(nullable: false),
                        IdentityID = c.String(nullable: false),
                        MerchantRivateKey = c.String(nullable: false),
                        PayPublicKey = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AccountMain", t => t.AccountMainID)
                .Index(t => t.AccountMainID);
                ...
                c => new
                    {
                        ...
                        TitleImage = c.String(nullable: false),
                        TitleShowImage = c.String(),
                        ...
                        HouseType = c.String(nullable: false, maxLength: 10),
                        EnumDecoration = c.Int(nullable: false),
                        Lease = c.Int(nullable: false),
                        Price = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Description = c.String(maxLength: 200),
                        Matching = c.String(nullable: false, maxLength: 200),
                        Introduction = c.String(nullable: false),
                        OwnerName = c.String(nullable: false, maxLength: 10),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Repairchargeso", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.RentalHouse", "AccountMainID", "dbo.AccountMain");
            ...
            DropForeignKey("dbo.PayInfo", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.PropertyOrderDetail", "PropertyOrderID", "dbo.PropertyOrder");
            DropForeignKey("dbo.PropertyOrder", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.PropertyOrderDetail", "PropertyFeeInfoID", "dbo.PropertyFeeInfo");
            DropForeignKey("dbo.PropertyFeeInfo", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.PropertyOrderDetail", "ParkingFeeID", "dbo.ParkingFee");
            DropForeignKey("dbo.PropertyOrderDetail", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.ParkingFee", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.Panorama", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.OrderMType", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.MicroSiteSetInfo", "AccountMainID", "dbo.AccountMain");
            ...
            DropForeignKey("dbo.ExpressCollection", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.Complaint", "UserID", "dbo.User");
            DropForeignKey("dbo.ComplaintReply", "ComplaintID", "dbo.Complaint");
            DropForeignKey("dbo.ComplaintReply", "AccountID", "dbo.Account");
            DropForeignKey("dbo.Complaint", "AccountMainID", "dbo.AccountMain");
            ...
            DropForeignKey("dbo.Property_User", "UserLoginInfoID", "dbo.UserLoginInfo");
            DropForeignKey("dbo.Property_User", "Property_HouseID", "dbo.Property_House");
            DropForeignKey("dbo.Property_House", "AccountMainHouseInfoID", "dbo.AccountMainHouseInfo");
            DropForeignKey("dbo.Property_House", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.Property_User", "AccountMainID", "dbo.AccountMain");
            ...
            DropForeignKey("dbo.RepairInfo", "UserID", "dbo.User");
            DropForeignKey("dbo.RepairOperation", "RepairInfoID", "dbo.RepairInfo");
            DropForeignKey("dbo.RepairInfo", "AccountMainID", "dbo.AccountMain");
            DropForeignKey("dbo.RepairInfo", "AccountID", "dbo.Account");
            ...
            DropForeignKey("dbo.ActivityInfo", "Lottery_eggID", "dbo.Lottery_egg");
            ...
            DropForeignKey("dbo.ActivityInfo", "Lottery_dishID", "dbo.Lottery_dish");
            ...
            DropForeignKey("dbo.M_TakeOutDetail", "M_TakeOutID", "dbo.M_TakeOut");
            DropForeignKey("dbo.M_Tutor", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_CommunityMapping", "M_TutorID", "dbo.M_Tutor");
            DropForeignKey("dbo.M_CommunityMapping", "M_TakeOutID", "dbo.M_TakeOut");
            DropForeignKey("dbo.M_PetHospital", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_CommunityMapping", "M_PetHospitalID", "dbo.M_PetHospital");
            DropForeignKey("dbo.M_EducationTrain", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_CommunityMapping", "M_EducationTrainID", "dbo.M_EducationTrain");
            DropForeignKey("dbo.M_DryCleaning", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_CommunityMapping", "M_DryCleaningID", "dbo.M_DryCleaning");
            DropForeignKey("dbo.M_Domestic", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_Unlock", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_CommunityMapping", "M_UnlockID", "dbo.M_Unlock");
            DropForeignKey("dbo.M_TakeOut", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_Product", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_CommunityMapping", "M_ProductID", "dbo.M_Product");
            DropForeignKey("dbo.M_PipelineDredge", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_CommunityMapping", "M_PipelineDredgeID", "dbo.M_PipelineDredge");
            DropForeignKey("dbo.M_Move", "MerchantID", "dbo.Merchant");
            DropForeignKey("dbo.M_CommunityMapping", "M_MoveID", "dbo.M_Move");
            DropForeignKey("dbo.M_CommunityMapping", "M_DomesticID", "dbo.M_Domestic");
            ...
            DropForeignKey("dbo.WebNotice", "MenuID", "dbo.Menu");
            DropForeignKey("dbo.WebNotice", "AccountMainID", "dbo.AccountMain");
            ...
            DropForeignKey("dbo.AboutUS", "AccountMainID", "dbo.AccountMain");
            ...
            DropIndex("dbo.Repairchargeso", new[] { "AccountMainID" });
            DropIndex("dbo.RentalHouse", new[] { "AccountMainID" });
            DropIndex("dbo.PushMsgDetail", new[] { "PushMsgID" });
            DropIndex("dbo.PushMsg", new[] { "AccountMainID" });
            DropIndex("dbo.PushMsg", new[] { "AccountID" });
            DropIndex("dbo.PayInfo", new[] { "AccountMainID" });
            DropIndex("dbo.PropertyOrderDetail", new[] { "PropertyOrderID" });
            DropIndex("dbo.PropertyOrder", new[] { "AccountMainID" });
            DropIndex("dbo.PropertyOrderDetail", new[] { "PropertyFeeInfoID" });
            DropIndex("dbo.PropertyFeeInfo", new[] { "AccountMainID" });
            DropIndex("dbo.PropertyOrderDetail", new[] { "ParkingFeeID" });
            DropIndex("dbo.PropertyOrderDetail", new[] { "AccountMainID" });
            DropIndex("dbo.ParkingFee", new[] { "AccountMainID" });
            DropIndex("dbo.Panorama", new[] { "AccountMainID" });
            DropIndex("dbo.OrderMType", new[] { "AccountMainID" });
            DropIndex("dbo.MicroSiteSetInfo", new[] { "AccountMainID" });
            ...
            DropIndex("dbo.ExpressCollection", new[] { "AccountMainID" });
            DropIndex("dbo.Complaint", new[] { "UserID" });
            DropIndex("dbo.ComplaintReply", new[] { "ComplaintID" });
            DropIndex("dbo.ComplaintReply", new[] { "AccountID" });
            DropIndex("dbo.Complaint", new[] { "AccountMainID" });
            ...
            DropIndex("dbo.Property_User", new[] { "UserLoginInfoID" });
            DropIndex("dbo.Property_User", new[] { "Property_HouseID" });
            DropIndex("dbo.Property_House", new[] { "AccountMainHouseInfoID" });
            DropIndex("dbo.Property_House", new[] { "AccountMainID" });
            DropIndex("dbo.Property_User", new[] { "AccountMainID" });
            ...
            DropIndex("dbo.RepairInfo", new[] { "UserID" });
            DropIndex("dbo.RepairOperation", new[] { "RepairInfoID" });
            DropIndex("dbo.RepairInfo", new[] { "AccountMainID" });
            DropIndex("dbo.RepairInfo", new[] { "AccountID" });
            ...
            DropIndex("dbo.M_TakeOutDetail", new[] { "M_TakeOutID" });
            DropIndex("dbo.M_Tutor", new[] { "MerchantID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_TutorID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_TakeOutID" });
            DropIndex("dbo.M_PetHospital", new[] { "MerchantID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_PetHospitalID" });
            DropIndex("dbo.M_EducationTrain", new[] { "MerchantID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_EducationTrainID" });
            DropIndex("dbo.M_DryCleaning", new[] { "MerchantID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_DryCleaningID" });
            DropIndex("dbo.M_Domestic", new[] { "MerchantID" });
            DropIndex("dbo.M_Unlock", new[] { "MerchantID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_UnlockID" });
            DropIndex("dbo.M_TakeOut", new[] { "MerchantID" });
            DropIndex("dbo.M_Product", new[] { "MerchantID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_ProductID" });
            DropIndex("dbo.M_PipelineDredge", new[] { "MerchantID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_PipelineDredgeID" });
            DropIndex("dbo.M_Move", new[] { "MerchantID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_MoveID" });
            DropIndex("dbo.M_CommunityMapping", new[] { "M_DomesticID" });
            ...
            DropIndex("dbo.WebNotice", new[] { "MenuID" });
            DropIndex("dbo.WebNotice", new[] { "AccountMainID" });
            ...
            DropIndex("dbo.AboutUS", new[] { "AccountMainID" });
            DropIndex("dbo.Account_AccountMain", new[] { "AccountID" });
            DropTable("dbo.Recipes");
            DropTable("dbo.LifeSkill");
            ...
            DropTable("dbo.Repairchargeso");
            DropTable("dbo.RentalHouse");
            DropTable("dbo.PushMsgDetail");
            DropTable("dbo.PushMsg");
            DropTable("dbo.PayInfo");
            DropTable("dbo.PropertyOrder");
            DropTable("dbo.PropertyFeeInfo");
            DropTable("dbo.PropertyOrderDetail");
            DropTable("dbo.ParkingFee");
            DropTable("dbo.Panorama");
            DropTable("dbo.OrderMType");
            DropTable("dbo.MicroSiteSetInfo");
            ...
            DropTable("dbo.ExpressCollection");
            DropTable("dbo.ComplaintReply");
            ...
            DropTable("dbo.Property_House");
            DropTable("dbo.Property_User");
            ...
            DropTable("dbo.RepairOperation");
            DropTable("dbo.RepairInfo");
            ...
            DropTable("dbo.M_TakeOutDetail");
            DropTable("dbo.M_Tutor");
            DropTable("dbo.M_PetHospital");
            DropTable("dbo.M_EducationTrain");
            DropTable("dbo.M_DryCleaning");
            DropTable("dbo.M_Unlock");
            DropTable("dbo.M_Product");
            DropTable("dbo.M_PipelineDredge");
            DropTable("dbo.M_Move");
            DropTable("dbo.Merchant");
            DropTable("dbo.M_Domestic");
            DropTable("dbo.M_CommunityMapping");
            DropTable("dbo.M_TakeOut");
