...
(function ($) {
    $.fn.showTopbarMessage = function (options) {
        ...
        var overlayStyle = "height: " + options.height + ";filter: alpha(opacity=50);-moz-opacity: 0.5;-khtml-opacity: 0.5;opacity: 0.5;background-color: " + options.background + ";border-bottom: solid 1px " + options.borderColor + ";";
