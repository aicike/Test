...
namespace Web.Controllers
{
    public class AppAdvertorialController : ManageAccountController
    {
        ...
        public ActionResult Add()
        {
            ...
            string WebTitleRemark = SystemConst.WebTitleRemark;
            string webTitle = string.Format(SystemConst.Business.WebTitle, "设置-用户端资讯-添加项目", LoginAccount.CurrentAccountMainName, WebTitleRemark);
            ViewBag.Title = webTitle;
        ...
        public ActionResult Edit(int id)
        {
            ...
            string WebTitleRemark = SystemConst.WebTitleRemark;
            string webTitle = string.Format(SystemConst.Business.WebTitle, "设置-用户端资讯-修改项目", LoginAccount.CurrentAccountMainName, WebTitleRemark);
            ViewBag.Title = webTitle;
        ...
        public ActionResult SelecInfo(int? id,int AID,int AMID,int ?type)
        {
            ...
            var aaoperation = AppAdvertorialOperationModel.getAOlist(AID,type.Value,LoginAccount.CurrentAccountMainID).ToPagedList(id ?? 1,15);
